...
\textbf{H3$_{0}$} : Der kognitive Vertrauenswert von Teams \ac{teamCog} korreliert nicht mit der realen Teameffektivität von Teams \ac{tRound} und der Kondition \ac{ik} stärker als von Teams mit der Kondition \ac{nik}. \\
%
%Was denke ich denn? Ich denke : 
...
H4$_{1}$ : Die reale Teameffektivität \ac{tRound} unterscheidet sich bei den Konditionen \ac{ik} und \ac{nik} signifikant voneinander. \newline
H4$_{0}$ : Die reale Teameffektivität \ac{tRound} unterscheidet sich bei den Konditionen \ac{ik} und \ac{nik} nicht voneinander. \\
%%----- ALT
...
\textbf{H5$_{0}$} : Der generelle Vertrauenswert eines Teams \ac{teamGen} korreliert nicht mit der realen Teameffektivität eines Teams \ac{tRound} und der Kondition \ac{ik} stärker als von Teams mit der Kondition \ac{nik}. \\
...
\item \textbf{Interaktionsmöglichkeiten}:  Durch das Verwendete Framework \textit{Normcore} und dessen globalen Datenspeicher für unterschiedliche Variablen, ist es möglich gewesen, alle Zustände und Informationen während der laufenden Versuchsdurchführung zwischen dem Client und Spectator zu synchronisieren.
...
Interessant : Es gibt eine Positive signifikante Korrelationzwischen CogTrust NIK und wahrg. Team Effek. NIK
