...
Bisherige Studien die einen Zusammenhang zwischen Vertrauen und Team-Effektivität darstellen, haben positive Zusammenhänge \citep{davis2000trusted}, keine Zusammenhänge \citep{hertel2004managing} sowie negative Zusammenhänge \citep{dirks1999effects} festgestellt.
	Diese Ausarbeitung zielt daher auf einen Teilaspekt dieser Fragestellung ab. Genauer darauf, herauszufinden, wie sich das Vertrauen zu Avataren in einem \ac{sve} \footnote{Grafikfigur, die die Onlinerepräsentation eines Nutzers darstellt. \citep[p.1]{neustaedter2009presenting}} auf die Effizienz eines Teams auswirkt. Dazu wird die Vertrauensbildung in einer Teambuildingmaßnahme sowie die Effizienz dieser anhand von Hand- und Kopf getrackten Avataren und Hand-, Kopf und Inverskinematisch-simuliertem Torsos getrackten Avataren verglichen.
...
Virtuelle Teams werden in dieser Arbeit als temporär, divers und räumlich gerennt, beschrieben. Die Kommunikation untereinander nur durch das World-Wide-Web statt. Weiterhin impliziert die temporäre Eigenschaft der Definition, dass sich die Teammitglieder nicht kennen.
		...
		\subsection{Trust}
		 ...
		 Mayer et al. (1995) conceptually defined trust as "a willingness of a party to be
...
or control that party" (p. 712)

Mayer, R. C., Davis, J. H., & Schoorman, F. D. (1995). An
integrative model of organizational trust. Academy of Management Review, 20, 709-734.
...
Mehrdimensionale, zuverlässige, Vertrauensforschung ist nur mittels Langzeitstudien möglich, denn Kognitives- und Affektives-Vertrauen eine Zeitliche Komponente benötigt.  (Jones &
George, 1998; McAllister, 1995)
