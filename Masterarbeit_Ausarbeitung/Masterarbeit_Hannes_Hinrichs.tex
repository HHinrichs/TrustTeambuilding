...
Die Hauptaufgabe des GameManagers ist somit die gesamte Verwaltung der Anwendung. Einer der wichtigsten Punkte ist jedoch das Netzwerkmanagement und RCP-Call Handling. 
Der GameManager steht in Verbindung mit den einzelnen Podesten der Spielers. Ein Podestmanager verwaltet einzelne Podeste, welche wiederum die einzelnen Knöpfe auf den Podesten verwalten. 
Drückt nun ein Spieler ein entsprechenden Knopf mit Symbol, sendet der Knopf eine Information über seinen Zustand an den Podestmanager. Dieser Überprüft, ob die zur Zeit gedrückten Knöpfe mit den zu drücktenden Knöpfen der Runde übereinstimmen. Falls diese das tun, wird eine bool-Variable im globalen Datastore umgeschaltet, der die restlichen Clients (inklusive Spectator) darüber informiert, dass ein Teilnehmer die korrekten Knöpfe gedrückt hat. Haben nun beide Spieler (Rot und Grün) die korrekten Knöpfe gedrückt und dadurch eine Flag im Datastore über die jeweilige Korrektheit gesetzt, registriert der GameManager des Spectators dies und setzt ein Flag über das Erfolgreiche abschließen der Runde. Die Clients registrieren dies und leiten die Startsequenz der nächsten Runde ein. 
