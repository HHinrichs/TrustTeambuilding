...
\begin{table}
	...
	\begin{tabular}{l c c c r}
		\underline{Was wurde gemessen?} & \underline{Variablenbeschreibung} & \underline{Mittelwert} & \underline{Std. Abweichung} & \underline{N} \\
		\hline \\
		Genereller Hang zum Vertrauen &X & Y & Z & 1 \\ \\
		Vertrauen in das Team &X & Y & Z & 1 \\
	\end{tabular}
\end{table}
