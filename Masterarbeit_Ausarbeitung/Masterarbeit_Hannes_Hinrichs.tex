...
Über den Einfluss von Self-Avataren zu Nicht-Self-Avataren wurde schon umfangreich geforscht. Wie sich Beispielsweise das Verhalten zur Interaktion mit der Welt verändert, wie sich soziale Interaktionen verändern und wie Aufgaben wahrgenommen und erledigt werden. \citep{benford1995user} \citep{bowers1996talk}
Studien gehen davon aus, dass ein menschlicher Körper als Avatar die Self-Präsenz stark erhöht.
Der Avatar muss nicht unverwechselbar menschlich aussehen um Self-Präsenz zu vermitteln, selbst grobe Avatar-Darstellungen schaffen es, ausreichende Informationen zu Vermitteln, so dass der Nutzer sich bei vorherig aufgeführten Aktionen anders verhält. \citep{lok2003effects}
