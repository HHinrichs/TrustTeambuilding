...
Anders ausgedrückt : \textit{Effizienz} beschreibt Mittel und Wege zur Erreichung der \textit{Effektivität}.

%Es müssen sich zur Erreichung von \textit{Effizienz} immer folgende Fragen gestellt werden :
...
Somit kann bei dem Begriff \textit{Effektivität} auch immer der Grad der Wirksamkeit berücksichtigt werden.
%
...
\begin{figure}[b!]
		...
		\centering
			...
			\caption[Abbildung 1]{Social presence response to vertical and
horizontal beings}
			\textit{Stationäre punkte, bei denen der Mensch eine lebendige Bewegung ausmachen kann, wenn diese Anfangen sich zu bewegen. Es ist sogar möglich einen Menschen zu erkennen sowie dessen Art der Aktivität und seinen emotionalen Zustand \citep{biocca2002defining} \citep[p.76-89]{johansson1975visual}.}
			\label{moving_dots}
		\end{footnotesize}
	\end{figure}
...
Die \textbf{Konditionsebene} unterscheidet zwischen den Konditionen \ac{ik} und \ac{nik}. Die Konditionsebene ordnet den einzelnen teilnehmenden Personen die Kondition zu, die diese im \ac{sve} als \textit{andere} Avatare wahrnehmen. 
...
\begin{figure}[H]
		\begin{footnotesize}
			...
			\caption{Framework inklusive Versuchshypothesen.}
...
\textbf{H3$_{0}$}: Der Zusammenhang des \ac{teamCog} und der realen Teameffektivität von Teams \ac{tRound} mit der Kondition \ac{ik} unterscheiden sich nicht signifikant von den Teams mit der Kondition \ac{nik}. \\
%
%Was denke ich denn? Ich denke : 
...
Der GameManager übernimmt alle wichtigen Funktionen zur Steuerung der Anwendung und der Netzwerkkommunikation. Diese sind unter anderem:
...
\begin{figure}[H]
		...
		\centering
			...
			\caption[Abbildung 1]{Diese Abbildung zeigt die Altersstruktur der Personen, die an dem Experiment teilgenommen haben.}
...
\begin{figure}[H]
		...
		\centering
			...
			\caption[Abbildung 1]{Diese Abbildung zeigt die Verteilung des Biologischen Geschlechts der Personen, die an dem Experiment teilgenommen haben}
...
\begin{figure}[H]
		...
		\centering
			...
			\caption[Abbildung 1]{Diese Abbildung zeigt den Bildungsstand der Teilnehmer, die an dem Experiment teilgenommen haben}
...
\begin{figure}[h]
  ...
  \caption{Diese Abbildung zeigt die VR Erfahrung (a) und die VR-Studien Erfahrung (b) der Teilnehmer.}
...
\begin{figure}[h]
  ...
  \caption{Diese Abbildung zeigt das Ausmaß der Internetnutzung (a) und das Ausmaß des Videospielkonsums (b) der Teilnehmer.}
...
Durch diese empfundene Einfachheit einzelner Teilnehmer könnten innerhalb eines Teams auch schneller Lerneffekte durch Repetitivität entstanden sein, die die Teameffektivität beeinflusst haben.
...
Während der Analyse der Hypothese 4 wurde festgestellt, dass es keinen Unterschied auf die Teameffektivität bei unterschiedlichen Avatarkonditionen besteht. Dies spiegelt sich auch in der Teameffektivität der Teams wieder. Bei beiden Teams ist die durchschnittliche Teameffektivität $x=9$.  
