...
Zum Messen der Teameffektivität (\textit{Siehe \nameref{Teameffektivität}}) im Zusammenhang mit dem generellen Vertrauen wurde \textbf{\textit{Hypothese 4}} aufgestellt. Zum Messen der Teameffektivität im Zusammenhang mit dem generellen Vertrauen wird \textbf{\textit{Hypothese 5}} aufgestellt :\\
...
Die \textit{Tabelle \ref{SignifikanzOverview} } zeigt eine Übersicht der einzelnen Hypothesen und deren Signifikanz nach der Auswertung.
