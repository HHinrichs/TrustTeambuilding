...
\multirow{3}{3.5cm}{Team-Kommunikation}
    ...
    \hline
\multirow{3}{3.5cm}{Communication-Quality-Scale}
	&Anzahl der Fragen im original Fragebogen (Bereinigter Fragebogen) \newline & B\\
    &\textit{n} \newline &Y\\
    &$\alpha$ (bereinigtes $\alpha$) & Z\\
...
\multirow{3}{3.5cm}{Igroup Presence Questionnaire(IPQ)}
    ...
    \hline
\multirow{3}{3.5cm}{Selbst gemeldete Co-Präsenz}
	&Anzahl der Fragen im original Fragebogen (Bereinigter Fragebogen) \newline & B\\
    &\textit{n} \newline &Y\\
    &$\alpha$ (bereinigtes $\alpha$) & Z\\
    
    \hline
\multirow{3}{3.5cm}{die wahrgenommene Präsenz des \flqq anderen\frqq}
	&Anzahl der Fragen im original Fragebogen (Bereinigter Fragebogen) \newline & B\\
    &\textit{n} \newline &Y\\
    &$\alpha$ (bereinigtes $\alpha$) & Z\\

    \hline
\multirow{3}{3.5cm}{Telepräsenz}
	&Anzahl der Fragen im original Fragebogen (Bereinigter Fragebogen) \newline & B\\
    &\textit{n} \newline &Y\\
    &$\alpha$ (bereinigtes $\alpha$) & Z\\

    \hline
\multirow{3}{3.5cm}{Social-Präsenz}
	&Anzahl der Fragen im original Fragebogen (Bereinigter Fragebogen) \newline & B\\
    &\textit{n} \newline &Y\\
    &$\alpha$ (bereinigtes $\alpha$) & Z\\
