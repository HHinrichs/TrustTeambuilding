...
Die unterschiedlichen Avatarkonditionen könnten einen Einfluss auf die Anzahl der Abgeschlossenen Runden eines Teams - und somit auf die Teameffektivität - haben (\textit{Siehe \nameref{Teameffektivität}}). Um dies zu untersuchen, wurde \textbf{\textit{Hypothese H4$_{1}$}} aufgestellt :\\
H4$_{1}$ : Die Anzahl erfolgreich abgeschlossener Runden \ac{tRound} unterscheidet sich bei den Konditionen \ac{ik} und \ac{nik} signifikant voneinander. \newline
