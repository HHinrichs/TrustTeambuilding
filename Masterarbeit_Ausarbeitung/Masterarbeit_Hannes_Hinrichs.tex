...
%https://sci-hub.ren/https://doi.org/10.1371/journal.pone.0025759 SEITE 2
	...
	\newpage
	\subsection{Teamwork}		
Als erstes wird sich mit der Frage beschäftigt, was denn überhaupt ein Team ist? Wie unterscheidet sich ein "normales" Team von einem Team, welches räumlich voneinander getrennt ist? "Normale" Teams, haben die Möglichkeit sich jederzeit oder mit einem geringem Zeitaufwand von Angesicht zu Angesicht zu treffen, während räumlich voneinander getrennte Teams nicht diese Möglichkeit besitzen.

		\subsubsection{Was ist Team?}
...
Vertrauen ist Allgegenwärtig. Jede zwischenmenschliche Beziehung beginnt mit einer frühen Phase der Vertrauensbildung. Diese frühen Phase kann mit Unsicherheiten und Zweifel charakterisiert werden. Das gegenseitige Vertrauen, dass man sich anschließend schenkt, muss erst einmal ausgelotet werden. \citep[p.166-168]{meyerson1996swift}

Während der frühen Phase der Vertrauensbildung entscheidet sich, ob eine Beziehung aufrecht erhalten werden sollte oder nicht. Unterbewusst bildet sich ein Gefühl von Zuversicht und Sicherheit oder ein Gefühl von Spannung, Zweifel und Skepsis. 
Dabei ist es egal, ob sich dafür entschieden wird jemandem zu Vertrauen oder nicht. Auf jeden Fall beeinflusst die Stärke des positiven oder negativen Vertrauensgefühl die Effektivität. Vertrauen kann es einfach oder schwierig machen mit einer anderen Person zu arbeiten und ziele in einer Gruppe oder einem Team zu erreichen.
...
Meinungen und annahmen, die sich frühzeitig bilden, prägen sich somit stark auch auf die eigene zukünftige Meinung über den Vertrauenserhalter aus.
