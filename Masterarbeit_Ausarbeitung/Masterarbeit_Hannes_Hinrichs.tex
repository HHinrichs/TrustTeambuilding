...
Ein Zeitslot von 30 Minuten teilte sich auf in
		...
		\end{itemize}
Jede teilnehmende Person bekam zu Beginn seines Zeitslots einen Pre-Questionnaire ausgehändigt, den dieser selbstständig ausfüllen sollte. In diesem wurde die Datenschutzerklärung ausgefüllt sowie Fragen über die \dq{}Person\dq{}, über eventuelle \dq{}Gesundheitliche Beschwerden\dq{} sowie schon vorhandene \dq{}\ac{vr}-Erfahrung\dq{}, gestellt.
...
Die maximale Versuchsdauer nach Start der Anwendung betrug exakt 10 Minuten (600 Sekunden). Es konnten maximal 15 Runden absolviert werden, wobei jede Runde inkrementell schwieriger wurde, da jede 3. Runde jeweils 1 Symbol, in den Pool der zu erratenden Symbole, hinzukam. 
	...
	\subsubsection{Allgemeiner Versuchsaufbau und technische }
...
\begin{itemize}
\item \textbf{Inkrementelle Erhöhung der Schwierigkeit}
\item \textbf{Teamfähigkeit}
\item \textbf{Neutrale Avatare}
...
\subsubsection{Online-Fähigkeit und Unterstützung mehrerer HMD's}
\subsubsection{Geringe Latenz}
\subsubsection{Steuerung und Verwaltung der Anwendung]}
\subsubsection{Interaktionsmöglichkeiten}
\subsubsection{Avatararten}

\subsubsection{Entwicklung der Versuchsumgebung}
...
Die unabhängigen Variablen sind der \dq{}\ac{ik}-Avatar\dq{} sowie der \dq{}\ac{ik}-IK-Avatar\dq{}. Durch diese beiden Variablen wurde im weiterem Versuchsverlauf versucht den Einfluss auf die abhängigen Variablen zu bestimmen.
...
\subsubsection{Anzahl der erledigten Aufgaben}
\subsubsection{Empfundene Team-Effektivität}
			
	\subsection{Residuen}
\begin{itemize}
\item \textbf{Kommunikation mit dem Spectator} Spectator spricht ....
\item \textbf{Farbe und Geschlecht der Avatare} Schwarz als neutrale Farbe, Möglichst "neutrales" avatar... auf Kristoffer Waldows Studie hinweisen
\item \textbf{Grad der Gamification} Einige Spieler könnten das \ac{vr} als Spiel empfinden, was Einfluss auf den eigentilchen Versuch hat.
\item \textbf{Kein Selbstavatar} Durch vorherige Studien sollte das eigentlich sein, aber möglicher bip verhindert dies. Selbstavatar wäre 
\end{itemize}



Es waren während des Versuchs einige Residuen vorhanden. Diese waren unter anderem der \textbf{Aufgabe der Umgebung}, die \textbf{Farbe der Avatare} und das \textbf{Geschlecht der Avatare}. Weiterhin gab es noch \textit{Sozialpsychiologische} Einflussfaktoren wie der Grad an \textbf{Gamification} der Anwendung, der Fakt, dass die eigenen Probanten \textbf{Keinen Selbst Avatar} besitzen sowie das \textbf{gesprochene Wort des Spectators}.
