...
Relativ wenige \ac{vr}-Anwendungen stellen den menschlichen Körper als Avatare dar. 
Über den Einfluss von Self-Avataren zu Nicht-Self-Avataren wurde schon umfangreich geforscht. \citep{benford1995user} \citep{bowers1996talk}
Studien gehen davon aus, dass ein menschlicher Körper als Avatar die Präsenz stark erhöht.
Der Avatar muss jedoch nicht perfekt aussehen, denn selbst grobe Avatar-Darstellungen vermitteln ausreichende Informationen über soziale Interaktionen. \citep{lok2003effects}
Über den Einfluss von Selbstavataren wurde schon viel geforscht. Darunter fallen :
-Einfluss auf Interaktionen mit der Welt, Einfluss auf die sozialen Interaktionen, Einfluss auf Aufgabenerledigungen.
