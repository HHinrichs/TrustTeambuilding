...
Since only the different avatar conditions have a significant impact on the formation of cognitive trust, it can be assumed that \textit{general trust} does not play a major role during a get-to-know phase of a virtual team and can be considered in isolation. %Check can be ignored? 
...
Another limitation of this study was, that participants knew before the experiment started, that they would be acting in a shared virtual environment with real people. %Check instead of bots?
