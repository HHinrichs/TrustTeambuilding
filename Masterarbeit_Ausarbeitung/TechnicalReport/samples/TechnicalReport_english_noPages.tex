...
\begin{teaserfigure}
  ...
  \Description{This figure shows the developed Shared-Virual-Environment with the avatar condition \textit{humanlike} (left) and \textit{non-humanlike} (right) during the execution of the experiment.}
  \label{fig:teaser}
\end{teaserfigure}
...
\begin{figure}[H]
  \centering
  \subfloat[][]{\includegraphics[width=0.42\linewidth]{Abbildungen/H2_Korr_IK_n.jpg}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.42\linewidth]{Abbildungen/H2_Korr_NIK_n.jpg}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.42\linewidth]{Abbildungen/H3_Korr_IK_n.jpg}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.42\linewidth]{Abbildungen/H3_Korr_NIK_n.jpg}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.42\linewidth]{Abbildungen/H5_Korr_IK_n.jpg}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.42\linewidth]{Abbildungen/H5_Korr_NIK_n.jpg}}
  \qquad
...
%\begin{figure}[]
%  \centering
%  \subfloat[][]{\includegraphics[width=0.7\linewidth]{Abbildungen/H1_Difference.jpg}}
%  \qquad
%  \subfloat[][]{\includegraphics[width=0.7\linewidth]{Abbildungen/H4_Difference.jpg}}
...
\begin{figure}[]
  \centering
  \subfloat[][]{\includegraphics[width=0.46\linewidth]{Abbildungen/SubDataTE_n.jpg}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.46\linewidth]{Abbildungen/SubDataTC_n.jpg}}
